# -*- coding: utf-8 -*-
"""
Created on Mon Oct 20 14:36:44 2014
...
def showSVM(svm):  
    ...
    min_x = min(svm.train_x[:, 0])[0, 0]-1  
    max_x = max(svm.train_x[:, 0])[0, 0]+1  
...
#test
train_x = [[1,8],[3,20],[1,15],[3,35],[5,35],[4,40],[7,80],[6,49]]
...
toler = 0.001  
maxIter = 50  
svmClassifier = trainSVM(train_x, train_y, C, toler, maxIter, kernelOption = ('rbf', 0))  
